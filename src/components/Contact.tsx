          ...
          >
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className="flex items-center space-x-4 p-4 bg-card border border-border rounded-xl hover:border-primary/50 transition-all duration-300 group"
                  >
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground font-inter">{info.label}</p>
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-glow-primary"
              >
                Download Resume
              </motion.a>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 font-inter"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 resize-none font-inter"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-secondary hover:bg-secondary/90 text-secondary-foreground px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-glow-secondary"
              >
                Send Message
              </motion.button>
            </form>
